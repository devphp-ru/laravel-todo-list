...
<div class="row">
    <div class="col-md-12">
        <button data-user-id="{{ $userId }}" type="button" class="btn btn-primary mt-3 mb-2 an_open-modal-create" data-bs-toggle="modal" data-bs-target="#an_modal-todo">
            Добавить
        </button>
        ...
        @endif
        <div id="an_tags-links" class="mt-2 mb-2">
            @if ($tags->isNotEmpty())
                <div class="mb-2">
                @foreach ($tags as $key => $name)
                    <span data-id="{{ $key }}" class="an_tag-link tag-click">{{ $name }}</span>
                @endforeach
                </div>
            @endif
            <div id="an_btn-filter-reset" class="col-auto  @if (!Request::has('filter'))an_btn-reset-hidden @endif">
                <a href="{{ route('todo.index') }}" class="btn btn-danger btn-sm mb-2 btn-width" title="Сбросить фильтр">Сбросить</a>
            </div>
        </div>
...
<div class="modal fade" id="an_modal-todo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="an_form-todo" enctype="multipart/form-data">
                <div class="modal-body modal-fields">
                    <input id="id" name="id" value="" type="hidden">
                    <input id="user_id" name="user_id" value="" type="hidden">
                    <input id="current_user_id" name="current_user_id" value="{{ $userId }}" type="hidden">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            <label for="tags-selectized" id="an_spinner-tags">Теги</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    Есть доступ: <div id="an_access-lists"></div>
                </div>
                <div class="mb-3">
